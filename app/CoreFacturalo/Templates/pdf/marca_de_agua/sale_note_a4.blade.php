...
<table class="full-width mt-10 mb-10">
    ...
    <tr class="bg-grey">
        ...
        <th class="border-top-bottom text-right py-2" class="cell-solid" width="8%">P.UNIT</th>
        <th class="border-top-bottom text-right py-2" class="cell-solid" width="8%">DTO.</th>
        <th class="border-top-bottom text-right py-2" class="cell-solid" width="8%">TOTAL</th>
    </tr>
    </thead>
    <tbody>
    @php
    ...
    @foreach($document->items as $row)
        <tr>
            ...
            @if($show_series_column) <td class="text-center align-top cell-solid-rl">
                @isset($row->item->lots)
                    @foreach($row->item->lots as $lot)
                        @if( isset($lot->has_sale) && $lot->has_sale)
