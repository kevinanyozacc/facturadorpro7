...
<table class="full-width mt-10 mb-10">
    ...
    <tr class="bg-grey">
        ...
        <th class="border-top-bottom text-center py-2" width="8%">@if($show_series_column) SERIE @endif</th>        
        @php
        ...
        <th class="border-top-bottom text-center py-2" width="8%">@if($showLoteColumn) F. VENC. @endif</th>
    ...
    @endforeach
        ...
        @if($document->total_charge > 0 && $document->charges)
            <tr>
                <td colspan="9" class="text-right font-bold">CARGOS ({{$document->getTotalFactor()}}%): {{ $document->currency_type->symbol }}</td>
