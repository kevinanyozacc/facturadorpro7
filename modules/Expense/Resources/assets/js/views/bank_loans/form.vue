            ...
            <div class="p-3">
                <form autocomplete="off" @submit.prevent="submit">
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-4">
                                <div
                                    :class="{
                                        'has-danger': errors.bank_account_id
                                    }"
                                    class="form-group"
                                >
                                    <label class="control-label">
                                    ...
                                    >
                                        <el-option
                                            v-for="option in bank_loan_method_types"
                                            :key="option.id"
                                            :label="option.description"
                                            :value="option.id"
                                        >
                            ...
                            <div class="col-lg-3 col-md-4">
                                <div
                                    :class="{
                                        'has-danger': errors.bank_loan_type_id
                                    }"
                                    class="form-group"
                                >
                                    <label class="control-label">
                                    ...
                                    <el-select v-model="form.bank_loan_type_id">
                                        <el-option
                                            v-for="option in bank_loan_types"
                                            :key="option.id"
                                            :label="option.description"
                                            :value="option.id"
                                        >
                        ...
                        <div v-if="form.items.length > 0" class="row mt-2">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <h3 v-if="form.total > 0" class="text-right">
                                    <b>TOTAL: </b>{{ currency_type.symbol }}
                                    {{ form.total }}
                                </h3>
                            </div>
                        </div>
                        ...
                        <!-- Cuoptas -->
                        <div v-if="form.total > 0" class="row col-lg-12 mt-3">
                            <!-- Pagos -->
                    ...
                    <div class="form-actions text-right mt-4">
                        ...
                        >
                        <el-button
                            v-if="form.items.length > 0 && !id"
                            :loading="loading_submit"
                            class="btn btn-primary btn-submit-default"
                            native-type="submit"
                            type="primary"
                            >{{ id ? "Actualizar" : "Generar" }}
                        </el-button>
                    </div>
                </form>
            </div>
...
export default {
        ...
        this.$http
            ...
            .then(response => {
                ...
                this.form.establishment_id = this.establishment.id
                    ...
                    : null;
                this.form.bank_loan_type_id =
                    this.bank_loan_types.length > 0
                        ? this.bank_loan_types[0].id
                        : null;
                this.form.loan_reason_id =
                    this.bank_loan_reasons.length > 0
                        ? this.bank_loan_reasons[0].id
                        : null;
                this.$store.commit(
                    "setPaymentMethodTypes",
                    data.payment_destinations
                );
    ...
    methods: {
        ...
        changeBank() {
            ...
            this.accounts_by_bank = _.filter(this.accounts, {
        ...
        resetForm() {
            ...
            this.form.establishment_id =
                this.config.establishment !== undefined
        ...
        calculateRowItem(row, currency_type_id, exchange_rate_sale) {
            ...
            if (
                ...
                currency_type_id_old !== currency_type_id
            ) {
        ...
        validate_payments() {
            ...
            this.form.payments.forEach(item => {
                ...
                if (
                    item.bank_loan_method_type_id != 1 &&
                    item.payment_destination_id == null
                )
                    empty_payment_destination++;
            });
