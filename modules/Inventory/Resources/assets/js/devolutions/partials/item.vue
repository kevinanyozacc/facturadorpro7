        ...
        <form autocomplete="off" @submit.prevent="clickAddItem">
            <div class="form-body">
                <div class="row">
                    ...
                    <div
                        class="col-md-4 mt-4"
                        v-if="form.item_id && form.item.lots_enabled"
                    >
                        <a
                            href="#"
...
export default {
    ...
    methods: {
        ...
        async clickAddItem() {
            ...
            let un_select_lots = await _.filter(this.form.item.lots, {
                has_sale: false
            });
            ...
            if (IdLoteSelected) {
                this.form.item.lot_selected = await _.find(
                    this.form.lots_group,
                    { id: IdLoteSelected, checked: true }
                );
            }
