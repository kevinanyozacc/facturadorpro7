...
//        return view('inventory::reports.inventory.index', compact('reports', 'warehouses'));
    ...
    {
        \Log::info("EXPORT: Iniciando export de inventario");
        ...
        \Log::info("EXPORT: Tray creado con ID: " . $tray->id);
        ...
        \Log::info("EXPORT: Website ID: " . $website_id);
        \Log::info("EXPORT: Warehouse ID: " . ($request->warehouse_id == 'all' ? 0 :  $request->warehouse_id));
        \Log::info("EXPORT: Filter: " . $request->input('filter'));
        ...
        \Log::info("EXPORT: Job despachado correctamente");
