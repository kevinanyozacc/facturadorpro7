    ...
    <div>
        <div class="page-header pr-0">
            ...
            <ol class="breadcrumbs">
                <li class="active">
                    <span>CHECK-IN (Asignar habitación)</span>
                </li>
            </ol>
        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div
                                    class="col-12 col-md-6 card-body bg-accent-color p-3"
                                >
                                    <p class="m-0">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <b class="text-xs">
                                            Tarifas disponibles</b
                                        >
                                        <span class="text-muted"
                                            >(Seleccione una tarifa para esta
                                            habitación)</span
                                        >
                                    </p>
                                    <div class="row">
                        ...
                        <div class="card-body py-0">
                            ...
                            <div class="row pt-3">
                                ...
                                <div
                                    ...
                                    :class="{
                                        'has-danger': errors.payment_status,
                                    }"
                                >
                ...
                <template v-else>
                    <div class="card text-center">
                        <div>
                            ...
                            >
                                <span class="ml-2"> Volver a recepción </span>
                            </el-button>
                        </div>
                    </div>
                </template>
...
export default {
    ...
    data() {
        return {
            ...
            form: {
                ...
                output_time: moment().add(8, "hours").format("HH:mm"),
                output_date: null,
                payment_status: "PAID",
                quantity_persons: 1,
                data_persons: [],
    ...
    watch: {
        "form.input_time"(val) {
            this.form.output_time = moment(val, "HH:mm")
                .add(8, "hours")
                .format("HH:mm");
        },
    },
    computed: {
        isPaid() {
            return (
                ...
                this.form.payment_status === "ACCOUNT"
            );
        },
        ...mapState(["config"]),
        ...
        canMakePayment: function () {
            if (
                this.form.sale_note_id != null ||
                this.room.status === "OCUPADO"
            ) {
                return false;
            }
            return true;
    ...
    methods: {
        ...
        onUpdateOutputDate() {
            ...
            this.form.output_time = moment(this.form.input_time, "HH:mm")
                .add(8, "hours")
                .format("HH:mm");
        },
        onSelectedRate() {
        ...
        async onUpdateItemsWithExtras() {
            try {
                ...
                this.document.items = this.document.items.map((it) => {
                    ...
                    const newItem = calculateRowItem(
                        it,
                        "PEN",
                        3,
                        this.percentage_igv
