<header class="header">
    ...
    <div class="header-right">
        <div class="dropdown-menu-mobile" style="display: none;">
            ...
            @php
                $_estabs_mobile = App\Models\Tenant\Establishment::select('id', 'description')->get();
                $_current_mobile = auth()->user()->establishment_id;
            @endphp
            <ul class="pendingWork-container">
                <li class="li-title-mobile">
                    <h4>Cambiar Sucursal</h4>
                </li>
                <li style="height: auto;">
                    <tenant-hotel-sucursale
                        :establishments='@json($_estabs_mobile)'
                        :current_establishment="{{ $_current_mobile }}"
                    ></tenant-hotel-sucursale>
                </li>
            </ul>
            @endif
