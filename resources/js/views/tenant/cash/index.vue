            ...
            <div class="card-body">
                <data-table :resource="resource">
                    ...
                    <tr slot-scope="{ index, row }">
                        ...
                        <td>{{ row.user }}</td>
                        <td class="text-left">{{ row.opening }}</td>
                        <td class="text-left">{{ row.closed }}</td>
                        ...
                        <td class="text-right">
                            ...
                            <div class="btn-group flex-wrap">
                                ...
                                <div class="dropdown-menu" role="menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 42px, 0px);">
                                    ...
                                    <a class="dropdown-item text-1" href="#" @click.prevent="clickDownloadReport(row.id, 'ticket','80',1)">PDF Ticket Resumen</a>
                            ...
                            <div class="btn-group flex-wrap">
                                ...
                                <div class="dropdown-menu" role="menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 42px, 0px);">
                                    ...
                                    <el-tooltip class="item"
                                                ...
                                                effect="dark"
                                                placement="right-end">
                                        <a class="dropdown-item text-1" href="#" @click.prevent="clickCashPaymentReportExcel(row.id)">Excel</a>
                                    </el-tooltip>
    ...
    export default {
        ...
        methods: {
            ...
            clickDownloadReport(id, template, mm = 80,summary = 0){
                if(template == 'ticket') {
                    window.open(`/${this.resource}/report-${template}/${id}/${mm}/${summary}`, '_blank');
