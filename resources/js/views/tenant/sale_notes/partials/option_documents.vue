            ...
            <div class="row">
                ...
                <div class="col-lg-8 mt-3">
                    ...
                    >
                        ...
                        >
                        <!-- DEBUG: {{ dispatches.length }} guías disponibles -->
                        <el-select
                            v-model="dispatch_id"
                            popper-class="el-select-dispatch"
                            filterable
                            class="border-left rounded-left border-info"
    ...
    methods: {
        ...
        async create() {
            ...
            await this.$http
                ...
                .then((response) => {
                    console.log("Dispatches API response:", response.data);
                    this.dispatches = response.data;
                    console.log("Dispatches assigned:", this.dispatches);
                });
        },
        changeDocumentType() {
            this.filterSeries();
