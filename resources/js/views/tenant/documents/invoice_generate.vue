        ...
        <div v-if="loading_form">
            <form autocomplete="off"
                ...
                <div class="col-xl-12 col-md-12 col-12">
                    <div class="row card-header card-header-invoice no-gutters align-items-start m-0">
                    ...
                    <div class="card-body border-top no-gutters">
                        ...
                        <div class="w-100">
                           ...
                           <div class="pl-5 pr-5 mt-5 no-gutters w-100">
                               <div class="col-12">
                        ...
                        <div class="table-responsive" v-loading="loading_items">
                            <table class="table table-sm">
                                ...
                                <tr v-for="(row, index) in form.items"
                                    ...
                                    <td class="text-right">
                                        <div v-if="showEditableItems" class="input-with-currency">
                                ...
                                <tr>
                                    ...
                                    <td class="pt-1"
                                        ...
                                        <div v-if="form.items.length > 0" class="total-rows mt-2">
                                                                ...
                                                                <tr v-for="(row, index) in form.fee"
                                                                    ...
                                                                    <td>
                                                                        <el-date-picker
                                                                            ...
                                                                            type="date"
                                                                            value-format="yyyy-MM-dd"
                                                                            :readonly="row.payment_method_type_id !== '09'">
                                                                        </el-date-picker>
                                                                    </td>
                                                                    <td>
                                                                        <el-input v-model="row.amount" :readonly="true"></el-input>
                                                                    </td>
                                                                </tr>
                                                                </tbody>
                                                            </table>
                                    ...
                                    <tr v-if="form.total > 0">
                                        ...
                                        <td class="p-0"
                                            ...
                                            <div v-if="!is_receivable && form.payment_condition_id === '01'" class="table-responsive payment">
                                                <table class="text-left payment-method">
                                                    <thead>
                                                    <tr>
                                                        <template v-if="showLoadVoucher && form.payments.length>0">
                                                            <th style="width:50px">Voucher</th>
...
export default {
    ...
    methods: {
        ...
        async changeDetractionType() {
            ...
            if (this.form.detraction) {
                ...
                if (this.form.currency_type_id == 'PEN') {
                    ...
                    total = ((this.form.detraction.reference_value_service > this.form.total) && this.form.operation_type_id == '1004')?this.form.detraction.reference_value_service:this.form.total;

                    // this.form.detraction.amount = _.round(parseFloat(this.form.total) * (parseFloat(this.form.detraction.percentage) / 100), 2)
                    this.form.detraction.amount = _.round(parseFloat(total) * (parseFloat(this.form.detraction.percentage) / 100), round)

                    this.form.total_pending_payment = this.form.total - this.form.detraction.amount

                } else {
                    total = ((this.form.detraction.reference_value_service > (parseFloat(this.form.total) * this.form.exchange_rate_sale)) && this.form.operation_type_id == '1004' )?this.form.detraction.reference_value_service:parseFloat(this.form.total) * this.form.exchange_rate_sale;
                    ...
                    this.form.detraction.amount = _.round( total* (parseFloat(this.form.detraction.percentage) / 100), round)
        ...
        async addRow(row) {
            ...
            if (this.$refs.item_search_quick_sale && this.$refs.item_search_quick_sale.search_item_by_barcode) {
                enable_barcode_quick_sale = this.$refs.item_search_quick_sale.search_item_by_barcode;
            }
            let enable_search_on_enter = false;
            if (this.$refs.item_search_quick_sale && this.$refs.item_search_quick_sale.searchOnEnter) {
                enable_search_on_enter = this.$refs.item_search_quick_sale.searchOnEnter;
            }
            ...
            if (this.recordItem) {
                ...
                let index = this.form.items.findIndex(item => item.item.internal_id === row.item.internal_id);
                if (index !== -1) {
                    let newItem = this.form.items[index];
                    newItem.quantity++;
                    let newRow = await calculateRowItem(newItem, row.item.currency_type_id, this.form.exchange_rate_sale, row.percentage_igv);
